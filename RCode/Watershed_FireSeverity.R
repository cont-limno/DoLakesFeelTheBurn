...
#test <- extract(MTBS_stack[[1]], buffer_erased, method='simple')
...
# this loop works, but is much slower for watersheds that actually have fire (flies through others)
